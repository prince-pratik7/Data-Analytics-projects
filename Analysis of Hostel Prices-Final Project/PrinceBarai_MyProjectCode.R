...
# COLLEGE : Unversity of Engineering & Managemnet, Kolkata

##setting the directory and assigning a variabel to the data frame
setwd(""C:/Users/prince_pratik7/Desktop/Machine Learning/Data Analytics/Data Visualisation/Final Project Beta")
